...
?>
    ...
    <body>
        <br />
        <h3 align="center">Sona Web Portal</h3>
        <br />
   ...
   ?>
                <div class="alert {{alertClass}} alert-dismissible" ng-show="alertMsg">
                    <a href="#" class="close" ng-click="closeMsg()" aria-label="close">&times;</a> {{alertMessage}}
                </div>
                ...
                <div class="panel panel-default" ng-show="register_form">
                    <div class="panel-heading">
                        <h3 class="panel-title">Request for register</h3>
                    </div>
                    <div class="panel-body">
